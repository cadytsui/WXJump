...
//		adbLocation = "/ ... /adt-bundle-mac-x86_64/sdk/platform-tools"; // MacOS X
    ...
    public void deviceChanged(IDevice idevice, int changeMask) { 
    	ADBDataController.getInstance().deviceChanged(idevice, changeMask);
    }

    @Override
    public void deviceConnected(IDevice idevice) {  
    	ADBDataController.getInstance().deviceConnected(idevice);
    }

    @Override
    public void deviceDisconnected(IDevice disconnectedDevice) {
    	ADBDataController.getInstance().deviceDisconnected(disconnectedDevice);
    }
